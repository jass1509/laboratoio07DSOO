...
public class VentanaRetiro extends JDialog {
    ...
    private JButton btnBuscar, btnRetirar, btnCancelar;
    private JLabel lblClienteInfo, lblSaldoActual, lblLimiteRetiro;
    private Cliente clienteSeleccionado;
    private Cuenta cuentaSeleccionada;
    
    public VentanaRetiro(Frame parent, Sistema sistema, Empleado empleadoActivo) {
        super(parent, "Realizar Retiro", true);
    ...
    private void initComponents() {
        ...
        lblSaldoActual.setForeground(new Color(52, 152, 219));
        panelTransaccion.add(lblSaldoActual, gbc);
        
        // Límite de retiro
        gbc.gridx = 0; gbc.gridy = 2; gbc.weightx = 0;
        panelTransaccion.add(new JLabel("Límite Diario:"), gbc);
        
        gbc.gridx = 1; gbc.weightx = 1.0;
        lblLimiteRetiro = new JLabel("S/ 1,000.00");
        lblLimiteRetiro.setFont(new Font("Arial", Font.PLAIN, 12));
        lblLimiteRetiro.setForeground(Color.GRAY);
        panelTransaccion.add(lblLimiteRetiro, gbc);
    ...
    private void realizarRetiro() {
        ...
        try {
            ...
            if (monto > 1000) {
                JOptionPane.showMessageDialog(this,
                    "El monto excede el límite diario de S/ 1,000.00",
                    "Límite Excedido",
                    JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            if (monto > cuentaSeleccionada.getSaldo()) {
                JOptionPane.showMessageDialog(this,
                    "Saldo insuficiente\n\n" +
                    "Saldo disponible: S/ " + String.format("%.2f", cuentaSeleccionada.getSaldo()) + "\n" +
                    "Monto solicitado: S/ " + String.format("%.2f", monto),
                    "Saldo Insuficiente",
                    JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            if (motivo.isEmpty()) {
                motivo = "Retiro en ventanilla";
            }
            
            // Crear transacción
            Transaccion retiro = new Retiro(
            ...
            boolean exitoso = sistema.gestionarTransaccion(retiro);
            ...
            if (exitoso) {
                ...
                JOptionPane.showMessageDialog(this,
                    "No se pudo procesar el retiro.\nVerifique el saldo y el límite diario.",
                    "Error en Retiro",
                    JOptionPane.ERROR_MESSAGE);
            }
            ...
            JOptionPane.showMessageDialog(this,
                "Error al realizar el retiro: " + ex.getMessage(),
                "Error",
                JOptionPane.ERROR_MESSAGE);
        }
    }
